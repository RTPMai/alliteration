...
const HEADER_CANDIDATES = {
  email: ["email", "attendeeemail", "emailaddress", "attendeeemailaddress", "email1", "contactemail", "buyeremail", "purchaseremail", "orderemail"],
  name: ["name", "fullname", "attendeename", "attendeefullname", "contactname", "buyername", "purchasername"],
  first: ["firstname", "attendeefirstname", "first", "givenname", "buyerfirstname"],
  last: ["lastname", "attendeelastname", "last", "surname", "familyname", "buyerlastname"],
  city_state: ["citystate", "location", "where"],
  city: ["city", "attendeecity", "billingcity", "shippingcity", "town"],
  state: ["state", "attendeestate", "stateprovince", "province", "region", "billingstate", "shippingstate"],
...
export function signupFromRow(row) {
  ...
  const name = pick(row, "name") || [first, last].filter(Boolean).join(" ");
