...
export const DEFAULT_POLICY = {
  ...
  coldDailyCapMax: 200,
  coldRampDays: 30,
  // Resend's free tier allows 100 emails a day across the whole account. A cap
  // above that does not send more, it starts a send that fails part way
  // through. Raise it to match the plan the day the account is upgraded.
  clientDailyCap: 100,
