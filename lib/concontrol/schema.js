...
export const OBLIGATIONS = [
  { key: "signage", label: "Logo on signage", tiers: ["Silver", "Gold", "Presenting"] },
  { key: "web", label: "Logo on website and agenda", tiers: ["Silver", "Gold", "Presenting"] },
  { key: "remarks", label: "Named in opening and closing", tiers: ["Silver", "Gold", "Presenting"] },
  { key: "bag", label: "Their materials in the bags", tiers: ["Silver", "Gold", "Presenting"] },
  { key: "social-group", label: "Group social recognition", tiers: ["Silver", "Gold", "Presenting"] },
  { key: "intro", label: "Intro to the room on day one", tiers: ["Gold", "Presenting"] },
  { key: "session-recognition", label: "Recognition at sessions and lunch", tiers: ["Gold", "Presenting"] },
  { key: "social-feature", label: "Dedicated social features", tiers: ["Gold", "Presenting"] },
  { key: "attendee-list", label: "Opt-in attendee list sent", tiers: ["Gold", "Presenting"] },
  { key: "branding", label: "Event branded with their name", tiers: ["Presenting"] },
  { key: "welcome", label: "Welcome address offered", tiers: ["Presenting"] },
  { key: "swag-logo", label: "Logo on bags and event apparel", tiers: ["Presenting"] },
  { key: "refusal", label: "2028 first refusal offered", tiers: ["Presenting"] },
];
