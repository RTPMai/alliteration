...
export const DEFAULT_ROLES = {
  ...
  employee: {
    ...
    tabs: ["crewcore:dashboard", "crewcore:timeclock", "crewcore:stipend", "crewcore:samples", "crewcore:reviews", "crewcore:handbook", "stitchsense:guess"],
    data_scope: "own",
    can_edit: false,
    can_export: false,
    manage_lists: false,
...
export async function permsFor(username) {
  ...
  const appGrants = Array.isArray(role.apps) ? role.apps.slice() : [];
  ...
  return {
    ...
    manage_lists: role.manage_lists === true,
    ...
    can_delete_notifications: role.can_delete_notifications !== false,
