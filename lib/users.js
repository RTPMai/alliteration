...
export const DEFAULT_ROLES = {
  ...
  employee: {
    ...
    tabs: ["crewcore:dashboard", "crewcore:roster", "crewcore:timeclock", "crewcore:stipend", "crewcore:reviews", "crewcore:handbook", "stitchsense:guess"],
    data_scope: "own",
    can_edit: false,
    can_export: false,
    manage_lists: false,
...
export async function getRoles() {
  ...
  if (stored && typeof stored === "object" && Object.keys(stored).length) {
    ...
    Object.keys(merged).forEach((name) => {
      if (DEFAULT_ROLES[name] && Array.isArray(DEFAULT_ROLES[name].tabs)) {
        merged[name] = { ...merged[name], tabs: DEFAULT_ROLES[name].tabs.slice() };
      }
    });
