...
export function validateSettings(body) {
  ...
  // every vendor's Reply at nothing.
  const wantsCapture = b.captureReplies === true;
  const domain = b.captureDomain !== undefined ? str(b.captureDomain, 200) : undefined;
  if (wantsCapture && domain !== undefined && !domain) {
