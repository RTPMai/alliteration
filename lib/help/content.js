...
a row stops retrying and waits for a person.`,
...

  {
    ...
    body: `MarketMachine runs each marketing campaign as an ordered checklist. It
was rebuilt in September 2026 from Jacob's campaign handoff. It is open to
Admins only for now.

PICK A TYPE AND THE STEPS ARE LAID OUT. There are thirteen campaign types:
...
Live Screen Printing, Live Customization, and External Trade Show. The New
campaign menu lists the most used types first.
