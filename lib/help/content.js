...
get My tasks, and only My tasks: the campaign screens, Timeline and Settings
stay off their rail and the server refuses them as well. The per-account Admin
flag is the only thing that opens the rest, and no checkbox on the account
editor can do it. They see the change the next time they sign in.
