...
only to superusers, and it is the list of work on building the platform
...
and it is limited to administrators and superusers because it changes what the
...
you to this screen.`,
...

  {
    ...
    keywords: ["settings", "account", "user", "password", "role",
      "permission", "access", "grant", "admin", "superuser", "data scope"],
...
SUPERUSER is a separate flag on the account itself rather than a role. It
overrides app access and is what makes the Site Work section visible.
...
ideas, bugs and things to add. It is superuser only, enforced on the server as
