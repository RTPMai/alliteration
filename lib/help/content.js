...
SEEING ONLY YOUR OWN ORDERS. Pipeline and Purchase Orders both carry a "Just
mine" button that narrows the screen to the orders you are the account manager
for. It stacks with Open, Late and All, so my late orders is one press each. It
stays on until you turn it off, including next time you sign in, and the screen
says so while it is on. If the button is not there, your shell account is not
linked to your CrewCore record: an administrator fixes that by putting your
username on your employee record in CrewCore.`,
  },
...
SEVEN SCREENS. Dashboard, Roster, Time Clock, Stipend, Reviews, Handbook,
Settings. Roster here means employees. In BackBone the same word means
