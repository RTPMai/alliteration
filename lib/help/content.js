...
ONE SCREEN TODAY. Sponsors. Money, Sessions and Speakers are designed and not
built, so they are not in the rail yet. A tab that opens onto "coming soon" is
a tab people stop clicking.
...
ACCESS. Any signed-in user can read, because "did that sponsor ever send their
logo" is a question anyone working the event should be able to answer without
asking. Editing needs edit rights. Deleting is admin only: the record holds
what was agreed and what was paid.`,
  },
