...
that level promises. ONLY CASH IS CASH, though, so the two are never added
together on a card: the sponsor board shows what was collected and then how much
of it was cash, and the Money screen counts only cash as income. A total that
adds a credit to the bank balance is a number somebody would quote and be wrong
about.

One honest limit worth knowing: a 7,000 credit only saves 7,000 if we were going
to spend 7,000 with them. Spend 3,000 and the rest is value that never happens.
The app records what was agreed; the ledger is where the actual spend shows up.
